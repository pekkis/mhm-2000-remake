...
| 48, 49               | none                                          | `rahna = 100000`, E.MHM:22 yes/no. "e" = V.MHM:16 (decline). "k" = negotiation `tarko` flips: hit = `+100k` + V.MHM:18; miss = `raha = -raha` (!! sets balance to its negation, i.e. wipes you to negative — **looks like a QB bug, preserve verbatim**) + V.MHM:17. ❓ TODO confirm. | interactive   | E:22, V:16/17/18               |
...
| 59                   | `tarko(charisma=6, w=15, b=50) = 1`           | `potti(pv) += rand(300000, 399999)` (jackpot accumulator), E.MHM:27. Money goes into **the season ticket pool**, not directly to balance.                                                                                                                                              | pre-resolved  | E:27                           |
...
2. **Extend `EventEffect` union** with the **NEW** items from §7.
   ...
   (h) misc (`tre`, `potti`, `boikotti`, `skout`).
