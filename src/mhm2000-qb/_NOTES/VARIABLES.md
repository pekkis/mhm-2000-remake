...
| `kar`  | INTEGER    | ❓ ("karenssi"? penalty days? "karkuri"? defector?) | TODO                  |
...
| `mtnimi() mtaito()`         | STRING/INTEGER | manager-trainer name+skill?                                                                            | TODO                 |
...
| `tazo()`                            | INTEGER   | tempo (taso = level/pace)            |              |
...
| `krjn()`                            | STRING\*1 | ❓ short tag                         | TODO         |
| `krj$`                              | STRING    | longer tag                           | TODO         |
